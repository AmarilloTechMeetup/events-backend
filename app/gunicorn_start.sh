...
DJANGODIR=/home/django/events-backend/app           # Django project directory
SOCKFILE=/home/django/django_env/run/gunicorn.sock  # we will communicte using this unix socket
